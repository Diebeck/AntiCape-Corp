...
import java.util.*;
/**
 * Clase que moldea el acceso a base de datos 
 * y todos sus metodos de consultas
 */
public class Acceso_BD {
	 ...
	 * en base a los atributos de la clase Acceso_DB
	 * 
	 ...
	 * @return true en caso de que se encuentre un registro y false si no se encuentra
	 */
	...
	/**
	 * Metodo que realiza una consulta a la base de datos para comprobar 
	...
	public ArrayList<Empleado> mostradoEmpleados() {
